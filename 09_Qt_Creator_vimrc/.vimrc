...
""  Rust analyzer inlayhint
let g:lsp_inlay_hints_enabled = 2
let g:lsp_inlay_hints_mode = {
\  'normal': ['always'],
\}
...
nnoremap <silent><nowait> L <C-w>gt<CR>
nnoremap <silent><nowait> H <C-w>gT<CR>
" nmap <silent> <Leader>j :tabfirst<CR>
" nmap <silent> <Leader>k :tablast<CR>
nnoremap <silent><nowait> <space>bt  :<C-u>tabe<CR>
nnoremap <silent><nowait> <space>btt  :terminal<CR>
" nnoremap <silent><nowait> <space>n  :<C-u>bn<CR>
" nnoremap <silent><nowait> <space>p  :<C-u>bp<CR>

nmap <silent> <Leader>t :CocDiagnostics<CR>
