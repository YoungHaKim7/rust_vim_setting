...
(custom-theme-set-faces
 ...
 '(ansi-color-black ((((class color) (min-colors 89)) (:background "#212526" :foreground "#212526"))))
 '(ansi-color-red ((((class color) (min-colors 89)) (:background "#ef2929" :foreground "#ef2929"))))
 '(ansi-color-green ((((class color) (min-colors 89)) (:background "#73d216" :foreground "#73d216"))))
 '(ansi-color-yellow ((((class color) (min-colors 89)) (:background "#edd400" :foreground "#edd400"))))
 '(ansi-color-blue ((((class color) (min-colors 89)) (:background "#3465a4" :foreground "#3465a4"))))
 '(ansi-color-magenta ((((class color) (min-colors 89)) (:background "#e090d7" :foreground "#e090d7"))))
 '(ansi-color-cyan ((((class color) (min-colors 89)) (:background "#06989a" :foreground "#06989a"))))
 '(ansi-color-white ((((class color) (min-colors 89)) (:background "#d3d7cf" :foreground "#d3d7cf"))))
 '(ansi-color-bright-black ((((class color) (min-colors 89)) (:background "#555753" :foreground "#555753"))))
 '(ansi-color-bright-red ((((class color) (min-colors 89)) (:background "#ff4b4b" :foreground "#ff4b4b"))))
 '(ansi-color-bright-green ((((class color) (min-colors 89)) (:background "#8ae234" :foreground "#8ae234"))))
 '(ansi-color-bright-yellow ((((class color) (min-colors 89)) (:background "#fce94f" :foreground "#fce94f"))))
 '(ansi-color-bright-blue ((((class color) (min-colors 89)) (:background "#8cc4ff" :foreground "#8cc4ff"))))
 '(ansi-color-bright-magenta ((((class color) (min-colors 89)) (:background "#e9b2e3" :foreground "#e9b2e3"))))
 '(ansi-color-bright-cyan ((((class color) (min-colors 89)) (:background "#34e2e2" :foreground "#34e2e2"))))
